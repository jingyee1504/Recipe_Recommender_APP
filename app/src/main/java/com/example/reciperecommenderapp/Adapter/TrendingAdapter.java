...
public class TrendingAdapter extends RecyclerView.Adapter<TrendingViewHolder> {
    ...
    public TrendingAdapter(Context context, List<RecipeAssistantClass> recipeList) {
    ...
    public TrendingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.grid_result_customize,parent,false);
    ...
    private void getClickNumber(TrendingViewHolder holder){
